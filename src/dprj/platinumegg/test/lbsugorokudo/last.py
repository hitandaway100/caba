...
class ApiTest(SugorokuApiTest):
    ...
    def setUp(self):
        ...
        # 停まるマス.
        self.update_squares_master(mapdata.mass_dict[3], prize=[prize.id], last=True)
        # ログインボーナス.
    ...
    def check(self):
        ...
        self.check_playerdata(playerdata, 3, [self.__mass_dict[loc].id for loc in (1,3)], self.__present_num + 1)
