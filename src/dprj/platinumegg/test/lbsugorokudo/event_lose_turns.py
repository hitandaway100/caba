...
class ApiTest(SugorokuApiTest):
    ...
    def setUp(self):
        ...
        # 停まるマス.
        self.update_squares_master(mapdata.mass_dict[7], event_type=Defines.SugorokuMapEventType.LOSE_TURN, event_value=1, prize=[prize.id])
        # ログインボーナス.
    ...
    def check(self):
        ...
        self.check_playerdata(playerdata, 7, [self.__mass_dict[loc].id for loc in (1,7)], self.__present_num + 1, lose_turns=1)
