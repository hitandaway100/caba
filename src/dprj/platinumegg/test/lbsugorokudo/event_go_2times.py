...
class ApiTest(SugorokuApiTest):
    ...
    def setUp(self):
        ...
        self.update_squares_master(mapdata.mass_dict[8], event_type=Defines.SugorokuMapEventType.GO, event_value=2)
        self.update_squares_master(mapdata.mass_dict[10], prize=[prize.id])
        # ログインボーナス.
    ...
    def check(self):
        ...
        self.check_playerdata(playerdata, 10, [self.__mass_dict[loc].id for loc in (1,7,8,10)], self.__present_num + 2)
