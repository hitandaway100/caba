...
class ApiTest(SugorokuApiTest):
    ...
    def setUp(self):
        ...
        # マップ.
        mapdata = self.create_map(7)
        self.__map_master = mapdata.map_master
        self.__mass_dict = mapdata.mass_dict
        # 停まるマス.
        self.update_squares_master(mapdata.mass_dict[7], prize=[prize.id])
        # ログインボーナス.
    ...
    def check(self):
        ...
        self.check_playerdata(playerdata, 7, [self.__mass_dict[loc].id for loc in (1,7)], self.__present_num + 1)
