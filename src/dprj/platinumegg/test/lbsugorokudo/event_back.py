...
class ApiTest(SugorokuApiTest):
    ...
    def setUp(self):
        ...
        # 停まるマス.
        self.update_squares_master(mapdata.mass_dict[7], event_type=Defines.SugorokuMapEventType.BACK, event_value=1, prize=[prize.id])
        self.update_squares_master(mapdata.mass_dict[6], prize=[prize.id])
        # ログインボーナス.
    ...
    def check(self):
        ...
        self.check_playerdata(playerdata, 6, [self.__mass_dict[loc].id for loc in (1,7,6)], self.__present_num + 2)
