...
class ApiTest(SugorokuApiTest):
    ...
    def setUp(self):
        ...
        # 停まるマス.
        self.update_squares_master(mapdata.mass_dict[1], prize=[prize.id])
        # ログインボーナス.
    ...
    def check(self):
        ...
        self.check_playerdata(playerdata, 1, [self.__mass_dict[loc].id for loc in (1,1)], self.__present_num + 1)
