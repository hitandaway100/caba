...
class ApiTest(SugorokuApiTest):
    ...
    def setUp(self):
        ...
        self.update_squares_master(mapdata.mass_dict[2], prize=[prize.id])
        # ログインボーナス.
    ...
    def check(self):
        ...
        self.check_playerdata(playerdata, 2, [self.__mass_dict[loc].id for loc in (1,7,2)], self.__present_num + 2)
