...
class ApiTest(ApiTestBase):
    ...
    def setUp(self):
        ...
        event_args = dict(pointprizes=pointprizes, lovetime_star=1, lovetime_timelimit=3600)
    ...
    def check(self):
        ...
        playdata = self.__scoutevent_util.get_scoutplaydata(self.__player0.id)
        if self.response['backUrl'].find('/sceventlovetime/{}/{}'.format(stagemaster.id, playdata.confirmkey)) == -1:
