...
import urllib
from platinumegg.app.cabaret.models.Happening import Happening, Raid
...
class ApiTest(ApiTestBase):
    ...
    def check(self):
        ...
        if levelupevent is None:
            ...
            raise AppTestError(u'完了イベントに正しくハプニングIDが設定されていない.%d vs %d' % (happening.mid, completeevent.scoutid))
