...
class ApiTest(ApiTestBase):
    ...
    def setUp(self):
        ...
        # ハート数.
        self.create_dummy(DummyType.SCOUT_EVENT_PRESENT_NUM, self.__player0.id, self.__eventmaster.id, point=100, result_number=0, result_pointpre=0, result_pointpost=1)
