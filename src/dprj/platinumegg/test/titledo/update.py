...
class ApiTest(ApiTestBase):
    ...
    def setUp(self):
        ...
        # 称号情報.
        titlemaster = self.create_dummy(DummyType.TITLE_MASTER, cost=100, days=1)
        self.create_dummy(DummyType.TITLE_PLAYER_DATA, uid=self.__player.id, title=titlemaster.id)
