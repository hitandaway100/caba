...
class ApiTest(BattleEventApiTestBase):
    ...
    def setUp2(self):
        ...
        # 贈り物のユーザ情報.
        self.__presentdata = self.makePresentData(self.__player0.id, eventmaster.id, point=self.__presentmaster.point, cur_presentmaster=self.__presentmaster, prev_presentmaster=self.__presentmaster)
