# -*- coding: utf-8 -*-
from platinumegg.test.raideventscoutresultanim import RaidEventScoutResultAnimApiTest
from platinumegg.test.dummy_factory import DummyType
from platinumegg.app.cabaret.util.scout import ScoutHappeningData

class ApiTest(RaidEventScoutResultAnimApiTest):
    """レイドイベントスカウト結果演出(ハプニング発生).
    """
