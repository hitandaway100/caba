...
class ApiTest(ApiTestBase):
    ...
    def setUp(self):
        ...
        now = OSAUtil.get_now()
        BackendApi.update_scouteventconfig(self.__eventmaster.id, now - datetime.timedelta(days=1), now - datetime.timedelta(days=1))
    ...
    def check(self):
        ...
        if self.response.get('is_opened'):
            raise AppTestError(u'イベントが発生してしまっている')
