...
from platinumegg.app.cabaret.models.Treasure import TreasureSilverMaster,\
    TreasureTableSilverMaster
...
class Handler(AdminModelEditHandler):
    ...
    def __valid_master(self, master):
        ...
        arr = model_mgr.get_models(TreasureSilverMaster, master.table)
