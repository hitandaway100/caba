...
from platinumegg.app.cabaret.kpi.models.movie import PcMovieViewCount
...
class Manager(KpiCSVBase):
    ...
    def get_data(self):
        """動画再生数.
        """
        data = PcMovieViewCount.aggregate(self.date)
        if not data:
            return None
    ...
    def delete(self):
        """動画再生数を削除.
        """
        return PcMovieViewCount.deleteByDate(self.date)
